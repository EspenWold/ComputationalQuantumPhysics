...
from plotting import energy_variance_plot, plot_positions
...
experiment_string = (f'_{3}d_{num_particles}p_interacting' if interacting
                     else f'_{3}d_{num_particles}p_non-interacting') + ".dat"
...
# # positions_file_path = positions_path(NAME_OF_SYSTEM + f'_{3}d_{10}p_interacting' + ".dat")
#
# positions = np.loadtxt(positions_file_path)
# plot_positions(positions=positions, resolution=100)